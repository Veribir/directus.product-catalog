...
const PRODUCT_DETAIL_FIELDS = [
  ...
  // variant spec groups — the only entry surface for specs (see schema guide §6).
  // A product's full spec sheet is the union of all its variants' groups/values.
  "variants.variant_spec_groups.id",
  "variants.variant_spec_groups.sort",
  "variants.variant_spec_groups.spec_group.id",
  "variants.variant_spec_groups.spec_group.icon",
  "variants.variant_spec_groups.spec_group.sort",
  "variants.variant_spec_groups.spec_group.irdi",
  "variants.variant_spec_groups.spec_group.translations.*",
  "variants.variant_spec_groups.variant_spec_values.id",
  "variants.variant_spec_groups.variant_spec_values.sort",
  "variants.variant_spec_groups.variant_spec_values.value",
  "variants.variant_spec_groups.variant_spec_values.spec.id",
  "variants.variant_spec_groups.variant_spec_values.spec.sort",
  "variants.variant_spec_groups.variant_spec_values.spec.status",
  "variants.variant_spec_groups.variant_spec_values.spec.display_type",
  "variants.variant_spec_groups.variant_spec_values.spec.irdi",
  "variants.variant_spec_groups.variant_spec_values.spec.eclass_preferred_name",
  "variants.variant_spec_groups.variant_spec_values.spec.translations.*",
  "variants.variant_spec_groups.variant_spec_values.spec.unit.id",
  "variants.variant_spec_groups.variant_spec_values.spec.unit.code",
  "variants.variant_spec_groups.variant_spec_values.spec.unit.symbol",
  "variants.variant_spec_groups.variant_spec_values.spec.unit.translations.*",
  // tags (M2M junction)
